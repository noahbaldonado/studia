...
The app is configured for Vercel deployment. Make sure all environment variables are set in your Vercel project settings. The build command is automatically detected from package.json.
